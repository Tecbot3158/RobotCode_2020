...
public class DifferentialDrive extends RobotDriveBase {
  ...
  private final TecbotSpeedController m_frontLeftMotor;
  private final TecbotSpeedController m_frontRightMotor;
  private final TecbotSpeedController m_middleLeftMotor;
  private final TecbotSpeedController m_middleRightMotor;
  private final TecbotSpeedController m_rearLeftMotor;
  private final TecbotSpeedController m_rearRightMotor;
  ...
  public DifferentialDrive(TecbotSpeedController frontLeftMotor, TecbotSpeedController frontRightMotor) {
    verify(frontLeftMotor, frontRightMotor);
  ...
  public DifferentialDrive(TecbotSpeedController frontLeftMotor, TecbotSpeedController frontRightMotor,
    ...
    addChild(m_frontLeftMotor);
    addChild(m_frontRightMotor);
    addChild(m_middleLeftMotor);
    addChild(m_middleRightMotor);
    addChild(m_rearLeftMotor);
    addChild(m_rearRightMotor);
    instances++;
    setName("DifferentialDrive", instances);
