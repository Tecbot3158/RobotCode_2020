...
public class PIDTurn extends PIDCommand {
    ...
    public boolean isFinished() {
        return (Math.abs(Robot.getRobotContainer().getDriveTrain().getPidAngleTarget() - Robot.getRobotContainer().getTecbotSensors().getYaw()) <= TecbotConstants.K_PID_TURN_ARRIVE_OFFSET);
    }
}
