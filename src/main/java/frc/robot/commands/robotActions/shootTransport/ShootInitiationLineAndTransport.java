...
public class ShootInitiationLineAndTransport extends SequentialCommandGroup {

        /**
         * <h3><strong>Shoot from Initiation Line and Transport</strong></h3>
         * <ul>
         *
         * <li>Intakes:
         * <ul>
         ...
         * </ul>
         */
    public ShootInitiationLineAndTransport() {
