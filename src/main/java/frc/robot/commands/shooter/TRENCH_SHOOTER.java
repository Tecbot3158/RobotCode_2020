...
public class TRENCH_SHOOTER extends PIDCommand {
  /**
   * Creates a new TRENCH_SHOOTER.
   */
  public TRENCH_SHOOTER() {
    super(
         ...
         () -> RobotContainer.getShooter().getShootingSpeed(ShooterPosition.TRENCH),
     ...
     RobotContainer.getShooter().getAnglerDegrees(ShooterPosition.TRENCH);
